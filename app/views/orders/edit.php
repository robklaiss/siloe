    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <form action="/orders/<?= htmlspecialchars($order['id']) ?>" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="status" id="status" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            <option value="pending" <?= (isset($_SESSION['old']['status']) ? $_SESSION['old']['status'] === 'pending' : $order['status'] === 'pending') ? 'selected' : '' ?>>Pending</option>
                            <option value="completed" <?= (isset($_SESSION['old']['status']) ? $_SESSION['old']['status'] === 'completed' : $order['status'] === 'completed') ? 'selected' : '' ?>>Completed</option>
                            <option value="cancelled" <?= (isset($_SESSION['old']['status']) ? $_SESSION['old']['status'] === 'cancelled' : $order['status'] === 'cancelled') ? 'selected' : '' ?>>Cancelled</option>
                        </select>
                    </div>
