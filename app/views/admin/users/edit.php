                ...
                <form action="/admin/users/<?= htmlspecialchars($user['id']) ?>" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="role" id="role" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            <option value="user" <?= (isset($_SESSION['old']['role']) ? $_SESSION['old']['role'] === 'user' : $user['role'] === 'user') ? 'selected' : '' ?>>User</option>
                            <option value="admin" <?= (isset($_SESSION['old']['role']) ? $_SESSION['old']['role'] === 'admin' : $user['role'] === 'admin') ? 'selected' : '' ?>>Admin</option>
                        </select>
                    </div>
