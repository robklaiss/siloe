                ...
                <form action="/menus/<?= htmlspecialchars($menu['id']) ?>" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" 
                               value="<?= isset($_SESSION['old']['name']) ? htmlspecialchars($_SESSION['old']['name']) : htmlspecialchars($menu['name']) ?>" 
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="description" rows="3" 
                                  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required><?= isset($_SESSION['old']['description']) ? htmlspecialchars($_SESSION['old']['description']) : htmlspecialchars($menu['description']) ?></textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            <input type="number" name="price" id="price" step="1" min="0" 
                                   value="<?= isset($_SESSION['old']['price']) ? htmlspecialchars($_SESSION['old']['price']) : htmlspecialchars($menu['price']) ?>" 
                    ...
                    <div class="mb-6">
                        ...
                        <select name="available" id="available" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            <option value="1" <?= (isset($_SESSION['old']['available']) ? $_SESSION['old']['available'] == 1 : $menu['available'] == 1) ? 'selected' : '' ?>>Available</option>
                            <option value="0" <?= (isset($_SESSION['old']['available']) ? $_SESSION['old']['available'] == 0 : $menu['available'] == 0) ? 'selected' : '' ?>>Not Available</option>
                        </select>
                    </div>
